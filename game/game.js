(function () {
  ...
  const PRODUCT_STORAGE = globalThis.ElAlameinProductStorage;
  if (!PRODUCT_STORAGE) throw new Error("El Alamein product storage was not initialized");
  const HAS_HEADQUARTERS_EVENTS = PRODUCT_PROFILE.features.headquartersEvents === true;

  const SAVE_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-save-v2");
  const LEGACY_SAVE_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-save-v1");
  const CHECKPOINT_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-turn-checkpoint-v1");
  const SESSION_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-current-session-v1");
  const LANG_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-lang");
  const AI_HUMAN_SIDE_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-human-side-v1");
  const AI_GAME_MODE_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-game-mode-v1");
  const ONLINE_ROOM_SESSION_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-online-room-v1");
  const HISTORICAL_NARRATIVE_PRESENTATION_PREFIX = `zizi-el-alamein-${PRODUCT_PROFILE.id}-historical-presentation-v1`;
  const TRAINING_LOG_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-training-log-v1");
  const TRAINING_EVENT_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-training-events-v1");
  const TRAINING_SESSION_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-training-session-v1");
  const HUMAN_DEMONSTRATION_RECORDING_KEY = PRODUCT_STORAGE.key("zizi-el-alamein-human-demonstration-recording-v1");
  ...
  const coreRulesPromise = import("./src/core/index.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const phaseFlowPromise = import("./src/app/phase-flow.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const menuModeSelectionPromise = import("./src/app/game-mode-selection.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const mapZoomPromise = import("./src/app/map-zoom.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const mapZoomControlsPromise = import("./src/ui/map-zoom-controls.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const historicalNarrativePromise = HAS_HEADQUARTERS_EVENTS
    ? import("./src/app/historical-narrative.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const historicalNarrativeSessionPromise = HAS_HEADQUARTERS_EVENTS
    ? import("./src/app/historical-narrative-session.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const historicalNarrativeGameStatePromise = HAS_HEADQUARTERS_EVENTS
    ? import("./src/app/historical-narrative-game-state.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const headquartersSurfacePromise = HAS_HEADQUARTERS_EVENTS
    ? import("./src/ui/headquarters-surface.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const turnBriefingOverlayPromise = HAS_HEADQUARTERS_EVENTS
    ? import("./src/ui/turn-briefing-overlay.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const aiHeuristicsPromise = import("./src/app/ai-heuristics.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const aiPhaseSearchPromise = import("./src/app/ai-phase-search.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const aiTacticsPromise = import("./src/app/ai-tactics.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const aiAlphaBrowserPromise = PRODUCT_PROFILE.features.alphaRuntime
    ? import("./src/app/ai-alpha-browser.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const aiAlphaPreviewPromise = PRODUCT_PROFILE.features.alphaRuntime
    ? import("./src/app/ai-alpha-preview.js?v=6a644862a44efa862d693def7dfce39ce4fec673")
    : Promise.resolve(null);
  const aiHumanDemonstrationPromise = import("./src/app/ai-alpha-human-demonstration.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const aiAlphaEnvironmentAdapterPromise = import("./src/app/ai-alpha-environment-adapter.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const aiAlphaTrainingPromise = import("./src/app/ai-alpha-training.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const alphaFingerprintPromise = import("../shared/wargame-alpha/fingerprint.js?v=6a644862a44efa862d693def7dfce39ce4fec673");
  const onlineModulesPromise = PRODUCT_PROFILE.features.onlineFriendMatch
    ? Promise.all([
      import("./src/app/supabase-online-transport.js?v=6a644862a44efa862d693def7dfce39ce4fec673"),
      import("./src/app/online-game-bridge.js?v=6a644862a44efa862d693def7dfce39ce4fec673"),
      import("./src/ui/online-multiplayer-panel.js?v=6a644862a44efa862d693def7dfce39ce4fec673"),
  ...
  Object.assign(I18N.zh.ui, {
    ...
    alphaValidatedModel: "Alpha\uff1a\u5df2\u9a8c\u8bc1\u6a21\u578b",
    alphaValidatedPreviewModel: "Alpha\uff1a\u5df2\u9a8c\u8bc1\u9884\u89c8\u6a21\u578b",
    alphaHeuristicFallback: "Alpha\uff1a\u542f\u53d1\u5f0f\u56de\u9000\uff08\u65e0\u6a21\u578b\uff09",
    alphaModelLoadFailed: "Alpha\uff1a\u6a21\u578b\u52a0\u8f7d\u5931\u8d25\uff0c\u5df2\u56de\u9000",
    trainingData: "\u8bad\u7ec3\u6570\u636e",
  ...
  Object.assign(I18N.en.ui, {
    ...
    alphaValidatedModel: "Alpha: validated model",
    alphaValidatedPreviewModel: "Alpha: validated preview model",
    alphaHeuristicFallback: "Alpha: heuristic fallback (no model)",
    alphaModelLoadFailed: "Alpha: model load failed; using fallback",
  ...
  const el = {
    ...
    headquartersRoot: document.getElementById("headquartersRoot"),
    turnBriefingRoot: document.getElementById("turnBriefingRoot"),
  ...
  const app = {
    ...
    historicalNarrativeModule: null,
    historicalNarrativeSessionModule: null,
    historicalNarrativeCatalog: null,
    historicalNarrativeGameState: null,
    historicalNarrativeEffectReducer: null,
    historicalNarrativeSession: null,
    headquartersSurface: null,
    turnBriefingOverlay: null,
    aiHeuristics: null,
    aiPhaseSearch: null,
    aiTactics: null,
    aiWeights: null,
    aiAlphaBrowser: null,
    aiAlpha: null,
    aiAlphaModelLoad: { status: "missing", value: null, reason: "model_missing" },
  ...
  async function chooseAiAlphaAction(options = {}) {
    const chooseActionPath = app.aiAlphaBrowser?.chooseBrowserAlphaGameActionPath;
    if (typeof chooseActionPath !== "function") return null;
    const adapter = app.aiAlphaGameAdapter ?? null;
    const eventStateBefore = adapter !== null ? clone(app.state) : null;
    return chooseActionPath({
      adapter,
      adapterContext: { searchOptions: options },
      browserChooser: app.aiAlphaBrowser?.chooseBrowserAlphaAction,
      browserContext: {
        alpha: app.aiAlpha,
        scenario: app.scenario,
        rules: app.rules,
      ...
      onRecommendation: adapter !== null
        ? (recommendation) => recordAlphaRecommendationEvent(recommendation, eventStateBefore)
        : null,
      logger: console,
    });
  }
  ...
  function scheduleAlphaAssessment() {
    if (historicalNarrativeBlocksInput()) return;
  ...
  function makeInitialState() {
    ...
    return {
      ...
      ...(HAS_HEADQUARTERS_EVENTS ? {
        historicalNarrative: app.historicalNarrativeModule.createState(),
        historicalFlags: {},
      } : {}),
      turn: 1,
      phaseIndex: 0,
  ...
  function normalizeState(state, options = {}) {
    ...
    if (app.historicalNarrativeGameState) {
      state.historicalNarrative = app.historicalNarrativeGameState
        .normalizeGameState(state)
        .historicalNarrative;
      state.historicalFlags = state.historicalFlags && typeof state.historicalFlags === "object" && !Array.isArray(state.historicalFlags)
        ? { ...state.historicalFlags }
        : {};
    } else {
      delete state.historicalNarrative;
      delete state.historicalFlags;
    }
  ...
  async function init() {
    try {
      const [
        ...
        mapZoom,
        mapZoomControlsUi,
        historicalNarrativeModule,
        historicalNarrativeSessionModule,
        historicalNarrativeGameStateModule,
        headquartersSurfaceUi,
        turnBriefingOverlayUi,
        aiHeuristics,
        aiPhaseSearch,
        aiTactics,
        aiAlphaBrowser,
        ...
        historicalNarrativePromise,
        historicalNarrativeSessionPromise,
        historicalNarrativeGameStatePromise,
        headquartersSurfacePromise,
        turnBriefingOverlayPromise,
        aiHeuristicsPromise,
        ...
        fetchJson("local-data/scenario.json?v=6a644862a44efa862d693def7dfce39ce4fec673"),
        fetchJson("local-data/rules.json?v=6a644862a44efa862d693def7dfce39ce4fec673"),
        HAS_HEADQUARTERS_EVENTS
          ? fetchJson("local-data/historical-events.json?v=6a644862a44efa862d693def7dfce39ce4fec673")
          : Promise.resolve(null),
        fetchJson("local-data/ai-weights-expert.json?v=6a644862a44efa862d693def7dfce39ce4fec673").catch(() => null),
        PRODUCT_PROFILE.features.alphaRuntime
          ? fetchOptionalJson("local-data/alpha-model.json?v=6a644862a44efa862d693def7dfce39ce4fec673")
      ...
      if (HAS_HEADQUARTERS_EVENTS) {
        app.historicalNarrativeModule = historicalNarrativeModule.createHistoricalNarrativeModule(historicalNarrativeCatalog);
        app.historicalNarrativeSessionModule = historicalNarrativeSessionModule;
        app.historicalNarrativeCatalog = historicalNarrativeCatalog;
        app.historicalNarrativeEffectReducer = historicalNarrativeModule.reduceHistoricalNarrativeEffects;
        app.historicalNarrativeGameState = historicalNarrativeGameStateModule.createHistoricalNarrativeGameStateAdapter({
          normalizeNarrativeState: (rawState) => app.historicalNarrativeModule.createState(rawState),
          createLegacyNarrativeState: (gameState) => app.historicalNarrativeModule.createLegacyState({
            turn: Number.isInteger(gameState.turn) && gameState.turn > 0 ? gameState.turn : 1,
            flags: Object.entries(gameState.historicalFlags || {})
      ...
      if (HAS_HEADQUARTERS_EVENTS) {
        el.headquartersRoot.hidden = false;
        el.turnBriefingRoot.hidden = false;
        app.headquartersSurface = headquartersSurfaceUi.createHeadquartersSurface({
          root: el.headquartersRoot,
          onCommand: handleHistoricalHeadquartersCommand,
        });
        app.turnBriefingOverlay = turnBriefingOverlayUi.createTurnBriefingOverlay({
          root: el.turnBriefingRoot,
          onDecision: handleHistoricalDecision,
        });
        app.historicalNarrativeSession = historicalNarrativeSessionModule.createHistoricalNarrativeSession({
          catalog: app.historicalNarrativeCatalog,
          initialState: app.state.historicalNarrative,
          language: app.lang,
          headquartersSurface: app.headquartersSurface,
          briefingOverlay: app.turnBriefingOverlay,
          onStateChange(nextState) {
            if (app.state) app.state.historicalNarrative = nextState;
          },
          onEffects: applyHistoricalNarrativeEffects,
        });
      }
      wireUi();
  ...
  function historicalNarrativeFlags() {
    return Object.entries(app.state?.historicalFlags || {})
      .filter(([, enabled]) => Boolean(enabled))
      .map(([flag]) => flag);
  }

  function syncHistoricalNarrativeSessionFromGameState() {
    if (!app.state || !app.historicalNarrativeSession) return;
    app.historicalNarrativeSession.replaceState(app.state.historicalNarrative);
    app.state.historicalNarrative = app.historicalNarrativeSession.getState();
  }

  function renderHistoricalNarrative() {
    if (!app.state || !app.historicalNarrativeSession) return;
    const active = el.body.dataset.view === "game";
    app.historicalNarrativeSession.setActive(active);
    if (!active) return;
    const narrativeState = app.historicalNarrativeSession.getState();
    if (narrativeState.lastStartedTurn < app.state.turn) {
      app.historicalNarrativeSession.startTurn({
        turn: app.state.turn,
        flags: historicalNarrativeFlags(),
      });
    } else {
      app.historicalNarrativeSession.render();
    }
  }

  function historicalNarrativeBlocksInput() {
    return Boolean(app.historicalNarrativeSession?.hasBlockingBriefing());
  }

  function handleHistoricalHeadquartersCommand(command) {
    app.historicalNarrativeSession?.handleHeadquartersCommand(command);
    if (isOnlineMatch()) saveOnlineHistoricalNarrativePresentation();
    else saveSessionState();
    draw();
  }

  function handleHistoricalDecision(decision) {
    app.historicalNarrativeSession?.handleDecision(decision);
    if (isOnlineMatch()) saveOnlineHistoricalNarrativePresentation();
    else saveSessionState();
    draw();
  }

  function applyHistoricalNarrativeEffects(effects) {
    if (!app.historicalNarrativeEffectReducer) return;
    app.state.historicalFlags = app.historicalNarrativeEffectReducer(
      app.state.historicalFlags,
      effects,
      { allowGameplay: !isOnlineMatch() },
    );
  }
  ...
  async function fetchOptionalJson(url) {
    try {
      ...
      if (response.status === 404) {
        return { status: "missing", value: null, reason: "model_missing" };
      }
      if (!response.ok) {
        return { status: "failed", value: null, reason: `${url}: ${response.status}` };
      }
      try {
        return { status: "loaded", value: await response.json(), reason: null };
      } catch (error) {
        return { status: "failed", value: null, reason: error?.message || "invalid_model_json" };
      }
    } catch (error) {
      return { status: "failed", value: null, reason: error?.message || "model_load_failed" };
    }
  }
  ...
  function historicalNarrativePresentationKey(roomCode) {
    const normalizedRoomCode = String(roomCode || "").trim().toUpperCase();
    return normalizedRoomCode
      ? `${HISTORICAL_NARRATIVE_PRESENTATION_PREFIX}:${encodeURIComponent(normalizedRoomCode)}`
      : null;
  }

  function readOnlineHistoricalNarrativePresentation(roomCode) {
    const key = historicalNarrativePresentationKey(roomCode);
    if (!key) return null;
    try {
      return JSON.parse(localStorage.getItem(key) || "null");
    } catch (error) {
      console.warn("Unable to read Online historical presentation state.", error);
      return null;
    }
  }

  function saveOnlineHistoricalNarrativePresentation(roomCode = onlineClientState()?.room?.roomCode) {
    const key = historicalNarrativePresentationKey(roomCode);
    if (!key || !app.state || !app.historicalNarrativeGameState) return;
    try {
      const presentation = app.historicalNarrativeGameState.extractPresentationState(app.state);
      localStorage.setItem(key, JSON.stringify(presentation));
    } catch (error) {
      console.warn("Unable to save Online historical presentation state.", error);
    }
  }
  ...
  function adoptOnlineRoomSnapshot(room) {
    ...
    const adoptedState = app.historicalNarrativeGameState
      ? app.historicalNarrativeGameState.adoptAuthoritativeState(
          clone(room.authoritativeState),
          readOnlineHistoricalNarrativePresentation(room.roomCode),
        )
      : clone(room.authoritativeState);
    const nextState = normalizeState(adoptedState, { preserveTransient: true });
    nextState.selectedUnitId = null;
    nextState.selectedDefenderId = null;
    nextState.selectedAttackers = [];
    nextState.log = [];
    app.state = nextState;
    syncHistoricalNarrativeSessionFromGameState();
    saveOnlineHistoricalNarrativePresentation(room.roomCode);
  ...
  function applyLanguage() {
    ...
    app.historicalNarrativeSession?.setLanguage(app.lang);
    drawAiControls();
    drawMapZoomControls();
  }
  ...
  function setView(view) {
    ...
    app.historicalNarrativeSessionModule?.syncHistoricalNarrativeSessionView(
      app.historicalNarrativeSession,
      view,
    );
  ...
  function drawMapZoomControls() {
    ...
    const manualPreference = isFit
      ? app.mapZoom.DEFAULT_MAP_ZOOM
      : app.mapZoom.normalizeMapZoom(app.mapZoomPreference);
    ...
    el.mapZoomOutput.textContent = isFit
      ? `${tr("ui.mapZoomFit")} ${zoomText}`
      : app.mapZoom.formatMapZoom(manualPreference);
  ...
  function isHumanInputBlocked() {
    if (historicalNarrativeBlocksInput()) return true;
    if (isOnlineMatch()) {
  ...
  function draw() {
    ...
    drawLog();
    updateMenu();
    if (!historicalNarrativeBlocksInput()) scheduleAlphaAssessment();
    scheduleAiTurn();
  }
  ...
  function drawStatus() {
    ...
    const blockInput = isHumanInputBlocked();
  ...
  function currentAlphaRuntimeMode() {
    return app.aiAlphaBrowser?.browserAlphaRuntimeMode?.({
      modelStatus: app.aiAlpha?.modelStatus || null,
      modelLoad: app.aiAlphaModelLoad,
    }) || {
  ...
  function alphaRuntimeStatusText(runtime) {
    if (runtime?.mode === "validated_preview_model") return tr("ui.alphaValidatedPreviewModel");
    if (runtime?.mode === "validated_model") return tr("ui.alphaValidatedModel");
    if (runtime?.mode === "load_failed") return tr("ui.alphaModelLoadFailed");
    return tr("ui.alphaHeuristicFallback");
  }
