import {
  ...
  stateHash,
} from "../core/environment.js?v=947ab7ad34ec8de82a35f78d806e2fc1d6d6ac07";
import {
  ENVIRONMENT_CONTRACT_VERSION,
  NODE_KIND,
  canonicalSerialize,
} from "../../../shared/wargame-alpha/environment-contract.js?v=947ab7ad34ec8de82a35f78d806e2fc1d6d6ac07";
import { alphaModelEnvironmentFingerprint } from "./ai-alpha-model.js?v=947ab7ad34ec8de82a35f78d806e2fc1d6d6ac07";
...
export function createElAlameinAlphaEnvironmentAdapter({ scenario, rules, board = null, instrumentation = null }) {
  ...
  function coreActions(state) {
    const generate = () => generateLegalActions(environmentForState(state), { includeChanceActions: true });
    return typeof instrumentation?.measure === "function"
      ? instrumentation.measure("legalActionGeneration", generate)
      : generate();
  }
